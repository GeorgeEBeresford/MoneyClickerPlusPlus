...
/***/ "./core/scripts/common/game-config.js":
/*!********************************************!*\
  !*** ./core/scripts/common/game-config.js ***!
  \********************************************/
...
/***/ "./core/scripts/common/knockout.js":
/*!*****************************************!*\
  !*** ./core/scripts/common/knockout.js ***!
  \*****************************************/
...
/***/ "./core/scripts/common/maths-library.js":
/*!**********************************************!*\
  !*** ./core/scripts/common/maths-library.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ MathsLibrary)
/* harmony export */ });
/**
...
/***/ "./core/scripts/companies/company.js":
/*!*******************************************!*\
  !*** ./core/scripts/companies/company.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _common_knockout__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../common/knockout */ "./core/scripts/common/knockout.js");
/* harmony import */ var _common_knockout__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_common_knockout__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _common_maths_library__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../common/maths-library */ "./core/scripts/common/maths-library.js");
...
class Company {
    ...
    constructor(isSystemOwned) {
        ...
        this.companyName = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.observable("");
        this.industry = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.observable("");
        this.stockType = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.observable(0);
        this.audits = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.observableArray([]);
        this.lastUpdated = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.observable(new Date(0));
        this.currentValue = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.observable(0);
        this.latestAudit = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.computed(() => {
            const audits = this.audits();
            const latestAudit = audits[audits.length - 1];
            return latestAudit;
        });
        this.stockValueChange = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.computed(() => {
            const audits = this.audits();
            if (audits.length < 2) {
                return 0;
            }
        ...
        this.historicValuesAscendingOrder = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.computed(() => {
            const audits = this.audits();
            const uniqueValues = [];
        ...
        this.valueHistoryTrend = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.computed(() => {
            const trendPoints = [];
        ...
        this.dividendsDescriptor = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.computed(() => {
        ...
        this.pricePerStock = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.computed(() => {
            ...
            switch (stockType) {
                // No dividends
                case 0:
                    pricePerStock = _common_maths_library__WEBPACK_IMPORTED_MODULE_1__["default"].round(currentValue / 850000000, 2);
                    break;
                // Low dividends
                case 1:
                    pricePerStock = _common_maths_library__WEBPACK_IMPORTED_MODULE_1__["default"].round(currentValue / 1300000000, 2);
                    break;
                // Medium dividends
                case 2:
                    pricePerStock = _common_maths_library__WEBPACK_IMPORTED_MODULE_1__["default"].round(currentValue / 2000000000, 2);
                    break;
                // High dividends
                case 3:
                    pricePerStock = _common_maths_library__WEBPACK_IMPORTED_MODULE_1__["default"].round(currentValue / 400000000, 2);
                    break;
                // Very high dividends
                case 4:
                    pricePerStock = _common_maths_library__WEBPACK_IMPORTED_MODULE_1__["default"].round(currentValue / 390000000, 2);
                    break;
                default:
     ...
     */
    makeRandomChange() {
        const noChangeRoll = _common_maths_library__WEBPACK_IMPORTED_MODULE_1__["default"].getRandomNumber(0, 100);
        if (noChangeRoll < 20) {
            // Archive the current value of the company
            this.audits.push({ pricePerStock: this.pricePerStock(), percentageChange: 0 });
        }
        else {
            const modificationIsLargeRoll = _common_maths_library__WEBPACK_IMPORTED_MODULE_1__["default"].getRandomNumber(0, 100);
            let modification = modificationIsLargeRoll < 0.0001 ? _common_maths_library__WEBPACK_IMPORTED_MODULE_1__["default"].getRandomNumber(10, 15) : _common_maths_library__WEBPACK_IMPORTED_MODULE_1__["default"].getRandomNumber(0.2, 3);
            const goodOrBadRoll = _common_maths_library__WEBPACK_IMPORTED_MODULE_1__["default"].getRandomNumber(0, 100);
            modification = goodOrBadRoll < 50 ? 0 - modification : modification;
            const roundedModification = _common_maths_library__WEBPACK_IMPORTED_MODULE_1__["default"].round(modification, 2);
            // Raise or decrease the stock value by a percentage, not the exact number
            const currentValue = this.currentValue();
            const roundedValue = _common_maths_library__WEBPACK_IMPORTED_MODULE_1__["default"].round(currentValue + currentValue * (roundedModification / 100), 2);
...
/***/ "./core/scripts/companies/stock-exchange.js":
/*!**************************************************!*\
  !*** ./core/scripts/companies/stock-exchange.js ***!
  \**************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ StockExchange)
/* harmony export */ });
/* harmony import */ var _common_knockout__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../common/knockout */ "./core/scripts/common/knockout.js");
/* harmony import */ var _common_knockout__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_common_knockout__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _company__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./company */ "./core/scripts/companies/company.js");
/* harmony import */ var _common_game_config__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../common/game-config */ "./core/scripts/common/game-config.js");
/* harmony import */ var _common_maths_library__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../common/maths-library */ "./core/scripts/common/maths-library.js");
...
class StockExchange {
     ...
     */
    constructor() {
        this.purchasedStock = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.observable({});
        this.stockIncomePerMinute = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.computed(() => {
        ...
        const companies = [];
        _common_game_config__WEBPACK_IMPORTED_MODULE_2__["default"].defaultCompanies.forEach(defaultCompany => {
            const generatedCompany = _company__WEBPACK_IMPORTED_MODULE_1__["default"].restoreSystemCompany(defaultCompany);
            companies.push(generatedCompany);
        });
        this.companies = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.observableArray(companies);
        this.playerInvestedCompanies = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.computed(() => {
        ...
        this.selectedCompany = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.observable(null);
        this.stockAmountToBuy = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.observable("1");
        this.priceToBuyStock = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.computed(() => {
            ...
            return _common_maths_library__WEBPACK_IMPORTED_MODULE_3__["default"].round(price, 2);
        });
        this.purchasedStockCount = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.computed(() => {
            const selectedCompany = this.selectedCompany();
            const purchasedStock = this.purchasedStock();
            if (selectedCompany === null) {
                return 0;
        ...
        this.playerStockProfit = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.computed(() => {
            const selectedCompany = this.selectedCompany();
            if (selectedCompany === null) {
                return 0;
            }
    ...
    static restore(savedStockExchange) {
        ...
        if (savedStockExchange !== null) {
            savedStockExchange.companies.forEach(playerCompany => {
                const savedCompany = _company__WEBPACK_IMPORTED_MODULE_1__["default"].restore(playerCompany);
...
/***/ "./core/scripts/companies/ticker.js":
/*!******************************************!*\
  !*** ./core/scripts/companies/ticker.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _common_knockout__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../common/knockout */ "./core/scripts/common/knockout.js");
/* harmony import */ var _common_knockout__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_common_knockout__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _stock_exchange__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./stock-exchange */ "./core/scripts/companies/stock-exchange.js");
...
class Ticker {
    ...
    constructor(stockExchange) {
        this.tickerInterval = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.observable(5000);
        this.maxPreviewedCompanies = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.observable(5);
        this.stockExchange = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.observable(stockExchange);
        this.companiesPreview = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.computed(() => {
        ...
        this.incomePerMinute = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.computed(() => {
            const stockExchange = this.stockExchange();
    ...
    static restore(savedTicker, player) {
        if (savedTicker !== null) {
            const savedStockExchange = _stock_exchange__WEBPACK_IMPORTED_MODULE_1__["default"].restore(savedTicker.stockExchange);
        ...
        const stockExchange = _stock_exchange__WEBPACK_IMPORTED_MODULE_1__["default"].restore(null);
...
/* harmony import */ var _common_knockout__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./common/knockout */ "./core/scripts/common/knockout.js");
/* harmony import */ var _common_knockout__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_common_knockout__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _money_money_generator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./money/money-generator */ "./core/scripts/money/money-generator.js");
/* harmony import */ var _companies_ticker__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./companies/ticker */ "./core/scripts/companies/ticker.js");
/* harmony import */ var _player_player__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./player/player */ "./core/scripts/player/player.js");
...
class Game {
    ...
    constructor(player, moneyGenerator, ticker) {
        this.player = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.observable(player);
        this.moneyGenerator = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.observable(moneyGenerator);
        this.ticker = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.observable(ticker);
        this.isNavigationBarShown = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.observable(false);
        this.currentPanel = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.observable(Game.defaultPanel);
        this.initialise();
    ...
    static restore(savedGame) {
        if (savedGame !== null) {
            const savedPlayer = _player_player__WEBPACK_IMPORTED_MODULE_3__["default"].restore(savedGame.player);
            const savedMoneyGenerator = _money_money_generator__WEBPACK_IMPORTED_MODULE_1__["default"].restore(savedGame.moneyGenerator);
            const savedTicker = _companies_ticker__WEBPACK_IMPORTED_MODULE_2__["default"].restore(savedGame.ticker, savedPlayer);
            const game = new Game(savedPlayer, savedMoneyGenerator, savedTicker);
            game.currentPanel(savedGame.currentPanel);
            return game;
        }
        const player = _player_player__WEBPACK_IMPORTED_MODULE_3__["default"].restore(null);
        const moneyGenerator = _money_money_generator__WEBPACK_IMPORTED_MODULE_1__["default"].restore(null);
        const ticker = _companies_ticker__WEBPACK_IMPORTED_MODULE_2__["default"].restore(null, player);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ Bank)
/* harmony export */ });
/* harmony import */ var _common_knockout__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../common/knockout */ "./core/scripts/common/knockout.js");
/* harmony import */ var _common_knockout__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_common_knockout__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _common_maths_library__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../common/maths-library */ "./core/scripts/common/maths-library.js");
...
class Bank {
     ...
     */
    constructor() {
        this.balance = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.observable(0);
    }
    /**
    ...
    toJSON() {
        return {
            ...
            balance: _common_maths_library__WEBPACK_IMPORTED_MODULE_1__["default"].floor(this.balance(), 2)
        };
    }
    /**
    ...
    deposit(amount) {
         ...
         */
        amount = _common_maths_library__WEBPACK_IMPORTED_MODULE_1__["default"].floor(amount, 2);
        this.balance(this.balance() + _common_maths_library__WEBPACK_IMPORTED_MODULE_1__["default"].round(amount, 2));
    }
    /**
...
/***/ "./core/scripts/money/money-generator.js":
/*!***********************************************!*\
  !*** ./core/scripts/money/money-generator.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ MoneyGenerator)
/* harmony export */ });
/* harmony import */ var _common_knockout__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../common/knockout */ "./core/scripts/common/knockout.js");
/* harmony import */ var _common_knockout__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_common_knockout__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _common_maths_library__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../common/maths-library */ "./core/scripts/common/maths-library.js");
...
class MoneyGenerator {
     ...
     */
    constructor() {
        this.baseCashPerClick = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.observable(1);
        this.boostExpires = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.observable(new Date(0));
        this.boostedSecondsRemaining = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.computed(() => {
        ...
        this.upgradeCost = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.computed(() => {
            var upgradeCost = 20 * Math.pow(this.baseCashPerClick(), 2);
            var flooredCost = _common_maths_library__WEBPACK_IMPORTED_MODULE_1__["default"].floor(upgradeCost, 2);
            return flooredCost;
        });
        this.cashPerClick = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.computed(() => {
...
/* harmony import */ var _common_knockout__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../common/knockout */ "./core/scripts/common/knockout.js");
/* harmony import */ var _common_knockout__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_common_knockout__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _money_bank__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../money/bank */ "./core/scripts/money/bank.js");
...
class Player {
     ...
     */
    constructor(bank) {
        this.bank = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.observable(bank);
    }
    /**
    ...
    static restore(savedPlayer) {
        if (savedPlayer !== null) {
            const savedBank = _money_bank__WEBPACK_IMPORTED_MODULE_1__["default"].restore(savedPlayer.bank);
            const player = new Player(savedBank);
            return player;
        }
        const bank = new _money_bank__WEBPACK_IMPORTED_MODULE_1__["default"]();
...
"use strict";
/*!********************************************!*\
  !*** ./core/scripts/persistent-storage.js ***!
  \********************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ PersistentStorage)
/* harmony export */ });
/* harmony import */ var _common_knockout__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./common/knockout */ "./core/scripts/common/knockout.js");
/* harmony import */ var _common_knockout__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_common_knockout__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _game__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./game */ "./core/scripts/game.js");
...
class PersistentStorage {
     ...
     */
    constructor(watchedGame) {
        this.watchedGame = watchedGame;
        this.delayBetweenSaves = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.observable(PersistentStorage.defaultTimeBetweenSaves);
        this.lastSavedOn = _common_knockout__WEBPACK_IMPORTED_MODULE_0__.observable(new Date(0));
    }
    /**
    ...
    static restore() {
        ...
        if (savedPersistentStorage !== null) {
            const game = _game__WEBPACK_IMPORTED_MODULE_1__["default"].restore(savedPersistentStorage.game);
        ...
        const game = _game__WEBPACK_IMPORTED_MODULE_1__["default"].restore(null);
        const persistentStorage = new PersistentStorage(game);
        return persistentStorage;
    }
    /**
    ...
    deleteSave() {
        ...
        this.watchedGame = _game__WEBPACK_IMPORTED_MODULE_1__["default"].restore(null);
    }
    /**
     ...
     */
    static migrateStorage(persistedStorage) {
...
PersistentStorage.storagePath = "moneyclicker++/savegame";
/**
...
window.addEventListener("load", () => {
    ...
    _common_knockout__WEBPACK_IMPORTED_MODULE_0__.applyBindings(persistentStorage.watchedGame);
});
